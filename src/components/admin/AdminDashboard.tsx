...
import { Settings, Upload, FolderOpen, Mail, FileText, LayoutDashboard, Plus } from "lucide-react"; // Added Plus here
import { useToast } from "@/hooks/use-toast";
import { supabase, portfolioApi, type Category, type Subcategory, type PortfolioItem, type Enquiry, type Resume } from "@/lib/supabase"; // Ensure supabase is imported correctly

import CategoryManager from "./CategoryManager";
import PortfolioManager from "./PortfolioManager"; // Corrected import path
...
const AdminDashboard = () => {
  ...
  const loadData = async () => {
    ...
    try {
      const [categoriesData, subcategoriesData, portfolioData, enquiriesData, resumesData] = await Promise.all([
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="portfolio">
            <PortfolioUpload categories={categories} subcategories={subcategories} onUpload={loadData} />
          </TabsContent>

          <TabsContent value="manage-portfolio">
            <PortfolioManager portfolioItems={portfolioItems} categories={categories} subcategories={subcategories} onUpdate={loadData} />
          </TabsContent>

          <TabsContent value="categories">
            <CategoryManager categories={categories} subcategories={subcategories} onUpdate={loadData} />
          </TabsContent>

          <TabsContent value="resumes">
            <ResumeManager resumes={resumes} onUpdate={loadData} />
          </TabsContent>
